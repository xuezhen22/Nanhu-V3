...
trait PMAMethod extends PMAConst {
  ...
  def pma_init() : (Vec[UInt], Vec[UInt], Vec[UInt]) = {
    ...
    addPMA(0x7ffffff000L, c = true, atomic = true, a = 1, w = true, r = true)
    addPMA(0x7c00000000L, c = true, atomic = true, a = 1, w = true, r = true, x = true)
    addPMA(0x6800000000L, c = true, atomic = true, a = 1, w = true, r = true)
    addPMA(0x0c00000000L, a = 1, w = true, r = true)
    addPMA(0x0b04400000L, a = 1, w = true, r = true, x = true)
    addPMA(0x0b04000000L, a = 1, w = true, r = true)
    addPMA(0x0080000000L, a = 1, w = true, r = true)
    addPMA(0x003c000000L, a = 1)
    addPMA(0x0039002000L, a = 1, w = true, r = true)
    addPMA(0x0039000000L, a = 1)
    addPMA(0x0038021000L, a = 1, w = true, r = true, x = true)
    addPMA(0x0038020000L, a = 1)
    addPMA(0x0038010000L, a = 1, w = true, r = true)
